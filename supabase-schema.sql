...
-- cv_path stores the Supabase Storage object path (private bucket); use cv-signed-url API to generate download links
alter table cv_submissions add column if not exists cv_path text;
